...
import { User, Mail, Lock, ShoppingBag } from "lucide-react" // Assuming Lucide React is installed via Shadcn
...
export default function CustomerSignupPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-zinc-50 via-white to-zinc-100 px-4 py-12 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[url('/api/placeholder/1920/1080?text=Join+Our+Store')] bg-cover bg-center opacity-5 mix-blend-multiply" />
      ...
      <Card className="w-full max-w-md relative z-10 border-0 bg-white/80 backdrop-blur-sm shadow-xl rounded-2xl overflow-hidden">
        <CardHeader className="bg-gradient-to-r from-zinc-900/5 to-zinc-800/5 pb-8 pt-12 text-center">
          ...
          <CardTitle className="text-3xl font-bold tracking-tight text-zinc-900">Create Your Account</CardTitle>
          <CardDescription className="text-zinc-600">Join our community and start shopping today</CardDescription>
        </CardHeader>
          ...
          <CardFooter className="flex flex-col space-y-6 pt-6">
            ...
            <div className="text-center space-y-2">
              ...
              <p className="text-xs text-zinc-500">
                ...
                <Link 
                  href="/signup/admin" 
                  className="font-medium text-zinc-700 hover:text-zinc-900 transition-colors duration-200 underline underline-offset-2 decoration-zinc-400"
                >
                  Register here
                </Link>
              </p>
